...
| `logLevel` | `INFO` | |
| `cpuRequest` | `100m` | |
| `memoryRequest` | `256Mi` | measured in the cluster: about 160 MiB per pod with the model loaded |
...
kubectl -n production describe analysisrun <name>   # every measurement with its value
```
